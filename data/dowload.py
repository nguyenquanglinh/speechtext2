...
def download_and_extract(directory, url):
  ...
  """
    ...
    try:
        ...
        with tarfile.open(directory + ".tar.gz", "r") as tar:
            tar.extractall(directory)
    finally:
        print(directory + ".tar.gz" + " extractall done")
...
path = "/home/linhnguyen/Downloads/dataEngLish"
...
def main(_):
    ...
    if FLAGS.train_only:
        ...
        download_and_process_datasets(path, LIBRI_SPEECH_URLS.keys())
